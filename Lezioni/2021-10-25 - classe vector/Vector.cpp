...
///ATTENZIONE: Questa non e' una funzione membro di Vector! 
///PS. non ho bisogno di usare friend perchè uso solo funzioni membro o operatori pubblici di Vector 
template<class R>
ostream& operator<<(ostream& os, const Vector<R>& v)
{
